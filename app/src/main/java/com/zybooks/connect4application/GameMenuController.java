...
import com.zybooks.connect4application.GameRules;
import com.zybooks.connect4application.GameRules.Disc;
import com.zybooks.connect4application.GameRules.FirstTurn;
import com.zybooks.connect4application.GameRules.Opponent;
import com.zybooks.connect4application.MenuView;
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        switch (checkedId) {
            ...
            case R.id.disc_yellow:
                mGameRules.setRule(GameRules.DISC2, GameRules.Disc.RED);
                mGameRules.setRule(GameRules.DISC, GameRules.Disc.YELLOW);
                break;
